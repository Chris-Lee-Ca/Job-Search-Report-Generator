...
This project includes a personal job assistant powered by Codex. When the user asks any question related to:
...
```json
"llm": { "provider": "Codex", "model": "Codex-haiku-4-5-20251001", "api_key_env": "ANTHROPIC_API_KEY" }
```
